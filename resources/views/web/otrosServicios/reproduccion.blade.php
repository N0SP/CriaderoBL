...
<section class="page-title centred" style="background-image: url({{asset('poopet/images/resource/banner-servicios.jpeg')}});">
        <div class="container">
            <h1>Servicio de reproducción y crianza de su perro</h1>
        </div>
    </section>
    <!-- page-title end -->
                    ...
                    <div class="service-details">
                        <div class="inner-box">
                            <div class="content-style-one">
                                <figure class="image-box"><img src="{{asset('poopet/images/resource/service-details-1.jpg')}}" alt=""></figure>
                        ...
                        <h3 class="sidebar-title">Servicios</h3>
                            <div class="widget-content">
                                <ul class="category-list">
                                    <li class="active"><a href="{{ route('reproduccion') }}">Reproducción y crianza responsable</a></li>
                                    ...
                                    <li><a href="{{ route('asesoria') }}">Asesoria de crianza y desarrollo de su perro</a></li>
