                    ...
                    <div class="service-details">
                        <div class="inner-box">
                            <div class="content-style-one">
                                <figure class="image-box"><img src="{{asset('poopet/images/resource/service-details-4.jpg')}}" alt=""></figure>
                        ...
                        <h3 class="sidebar-title">Servicios</h3>
                            <div class="widget-content">
                                <ul class="category-list">
                                    ...
                                    <li class="active"><a href="{{ route('entrenamiento') }}">Planes de entrenamiento</a></li>
