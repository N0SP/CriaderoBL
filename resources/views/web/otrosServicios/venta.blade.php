...
<section class="page-title centred" style="background-image: url({{asset('poopet/images/resource/banner-servicios.jpeg')}});">
        <div class="container">
            <h1>Venta de alimentos y suplementos</h1>
        </div>
    </section>
    <!-- page-title end -->
                    ...
                    <div class="service-details">
                        <div class="inner-box">
                            <div class="content-style-one">
                                <figure class="image-box"><img src="{{asset('poopet/images/resource/service-details-6.jpg')}}" alt=""></figure>
                        ...
                        <h3 class="sidebar-title">Servicios</h3>
                            <div class="widget-content">
                                <ul class="category-list">
                                    ...
                                    <li class="active"><a href="{{ route('venta') }}">Venta de alimentos y suplementos</a></li>
                                </ul>
                            </div>
                        </div>
